...
public class CreditCardDetailConsumerConfig {
    ...
    @Bean
    ConsumerFactory<String, CreditCardDetail> consumerConfig() {
...
//        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.jabar.app.creditcarddetail.CreditCardDetail");
//        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, CreditCardDetail> creditCardDetailListenerContainerFactory(ConsumerFactory<String, CreditCardDetail> consumerFactory) {
